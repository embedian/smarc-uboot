...
#define CFG_EXTRA_ENV_SETTINGS \
	...
	"console=ttymxc3,115200 earlycon=ec_imx6q,0x30890000,115200\0" \
	"bootargs=console=ttymxc3,115200 earlycon=ec_imx6q,0x30890000,115200 ubi.mtd=nandrootfs "  \
...
#define CFG_EXTRA_ENV_SETTINGS		\
	...
	"loadfdt=load mmc ${mmcdev}:${mmcpart} ${fdt_addr_r} /dtbs/${fdtfile}\0" \

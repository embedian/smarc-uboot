...
#define CFG_EXTRA_ENV_SETTINGS		\
	...
	"loadbootenv=ext4load mmc ${mmcdev}:${mmcpart} ${env_addr} uEnv.txt\0" \
	"loadusbbootenv=ext4load usb 0:1 ${env_addr} uEnv.txt\0" \
	"mmcautodetect=yes\0" \
	...
	"loadusbfdt=ext4load usb 0:1 ${fdt_addr} /dtbs/${fdt_file}\0" \
...
#define CFG_CONSOLE	"console=ttyLP1\0"

 ...
 * Copyright 2018 NXP
 * Copyright 2025 EMBEDIAN
 *
 * Configuration settings for the Freescale i.MX6Q SabreSD board.
 */

#ifndef __SMARCFIMX6_COMMON_CONFIG_H
#define __SMARCFIMX6_COMMON_CONFIG_H
...
#define CFG_EXTRA_ENV_SETTINGS \
		...
		"bootcmd_sata=run bootargs_sata; scsi scan; " \
			...
			"fatload scsi 0:1 ${fdt_addr} /dtbs/${fdt_file}; " \
			"if test ${tee} = yes; then " \
...
#define CFG_EXTRA_ENV_SETTINGS \
	...
	"ip_dyn=yes\0" \
	"console=" CONSOLE_DEV "\0" \
	"dfuspi=dfu 1 sf 0:0:10000000:0\0" \
	...
	"netboot=echo Booting from net ...; " \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				...
				"if test $board_name = SMCMX1QP || test $board_name = SMCMX2QP && test $board_rev = MX6QP; then " \
					"setenv fdt_file imx6qp-smarc.dtb; fi; " \
				"if test $board_name = SMCMXQ1G || test $board_name = SMCMXQ2G || test $board_name = SMCMXD1G || test $board_name = SMCMXD2G && test $board_rev = MX6Q; then " \
					"setenv fdt_file imx6q-smarc.dtb; fi; " \
				"if test $board_name = SMCMXU1G || test $board_name = SMCMXSLO && test $board_rev = MX6DL; then " \
					"setenv fdt_file imx6dl-smarc.dtb; fi; " \
...
#define CONFIG_SYS_I2C_BUSES	{	{0, {I2C_NULL_HOP}}, \
					{1, {I2C_NULL_HOP}}, \
					{2, {{I2C_MUX_PCA9546, 0x70, 1}}}, \
					{2, {{I2C_MUX_PCA9546, 0x70, 2}}}, \
					{2, {{I2C_MUX_PCA9546, 0x70, 3}}}, \
				}

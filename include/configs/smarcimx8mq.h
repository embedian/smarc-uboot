...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"script=boot.scr\0" \
	"image=Image\0" \
	"console=" CONSOLE_DEV ",115200 earlycon=ec_imx6q,0x30860000,115200\0" \
	...
	"mmcautodetect=yes\0" \
        ...
        "usbargs=setenv bootargs console=${console} ${optargs} " \
...
#define PHYS_SDRAM_SIZE                 0x60000000 /* 2GB DDR */
#else

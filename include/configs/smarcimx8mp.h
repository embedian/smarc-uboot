...
#ifndef __SMARCIMX8MP_H
#define __SMARCIMX8MP_H
...
#define JAILHOUSE_ENV \
	"jh_clk= \0 " \
	"jh_mmcboot=setenv fdt_file imx8mp-smarc.dtb;" \
		"setenv jh_clk clk_ignore_unused; " \
			   "if run loadimage; then " \
				   "run mmcboot; " \
			   "else run jh_netboot; fi; \0" \
	"jh_netboot=setenv fdt_file imx8mp-smarc.dtb; setenv jh_clk clk_ignore_unused; run netboot; \0 "

...
#ifndef SMARCFIMX6_ANDROID_COMMON_H
#define SMARCFIMX6_ANDROID_COMMON_H
...
#define CONFIG_FASTBOOT_MANUFACTURER_STR  "Embedian"
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR "SMARC FiMX6"

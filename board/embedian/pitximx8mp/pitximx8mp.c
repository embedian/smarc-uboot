...
static iomux_v3_cfg_t const misc_pads[] = {
	MX8MP_PAD_SD2_WP__GPIO2_IO20 | MUX_PAD_CTRL(WEAK_PULLUP),		/* M.2_IRQ */
	MX8MP_PAD_SAI1_TXD7__GPIO4_IO19 | MUX_PAD_CTRL(WEAK_PULLUP),		/* TPM_IRQ# */
	MX8MP_PAD_ECSPI2_MOSI__GPIO5_IO11 | MUX_PAD_CTRL(WEAK_PULLUP),		/* TPM_PP */
	MX8MP_PAD_ECSPI2_SCLK__GPIO5_IO10 | MUX_PAD_CTRL(WEAK_PULLUP),		/* TPM_LP */
	MX8MP_PAD_SAI2_RXC__GPIO4_IO22 | MUX_PAD_CTRL(WEAK_PULLUP),		/* TCA6408 IO Expander INT# (M.2)*/
	MX8MP_PAD_SAI3_TXC__GPIO5_IO00 | MUX_PAD_CTRL(WEAK_PULLUP),		/* TCA6408 IO Expander INT# (MPCIe)*/
	MX8MP_PAD_SAI3_RXFS__GPIO4_IO28 | MUX_PAD_CTRL(WEAK_PULLUP),		/* AUD_INT# */
	MX8MP_PAD_GPIO1_IO15__GPIO1_IO15 | MUX_PAD_CTRL(WEAK_PULLUP),		/* TS_INT# */
	...
	MX8MP_PAD_NAND_DATA02__GPIO3_IO08 | MUX_PAD_CTRL(WEAK_PULLUP),		/* CAM2_PWR# */
	MX8MP_PAD_NAND_DATA03__GPIO3_IO09 | MUX_PAD_CTRL(WEAK_PULLUP),		/* CAM2_RST# */
	MX8MP_PAD_SAI1_RXFS__GPIO4_IO00 | MUX_PAD_CTRL(WEAK_PULLUP),		/* CAM2_VSYNC */
	MX8MP_PAD_SPDIF_EXT_CLK__GPIO5_IO05 | MUX_PAD_CTRL(WEAK_PULLUP),	/* EIO_PWR_EN */
};
...
int board_late_init(void)
{
	...
	*/
	...
	if ((gpio_get_value(IMX_GPIO_NR(1, 5)) == 1)) {
		puts("BOOT_SEL Detected: ON, Load Image from SD Card...\n");
                ...
                puts("BOOT_SEL Detected: OFF, Load Image from eMMC Flash...\n");

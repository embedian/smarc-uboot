...
static inline int board_is_smarc_t437x_800(void)
{
        return !strncmp(am43xx_board_name, "SMCT4X80", HDR_NAME_LEN);
}

static inline int board_is_smarc_t437x_01g(void)
{
        return !strncmp(am43xx_board_name, "SMCT4X1G", HDR_NAME_LEN);
}

...
static iomux_v3_cfg_t const misc_pads[] = {
	...
	IMX8MQ_PAD_NAND_DATA05__GPIO3_IO11 | MUX_PAD_CTRL(WEAK_PULLUP),		/*S151, CHARGING#*/
...
/* SMARC BOOT_SEL*/
	...
	if ((gpio_get_value(IMX_GPIO_NR(1, 8)) == 0)&&(gpio_get_value(IMX_GPIO_NR(1, 5)) == 0)&&(gpio_get_value(IMX_GPIO_NR(1, 6)) == 0)) {
		...
		if (!env_get("bootcmd"))
		env_set("bootcmd", "i2c dev 0; i2c mw 0x08 0x1a 0xf; boota mmc1");
		...
		if (!env_get("bootcmd"))
			env_set("bootcmd", "i2c dev 0; i2c mw 0x08 0x1a 0xf; boota mmc0");

...
static inline int board_is_bbg1(struct am335x_baseboard_id *header)
{
        return !strncmp("BBG1", header->name, 4);
}

static inline int board_is_icev2(struct am335x_baseboard_id *header)
{
        return !strncmp("A335_ICE", header->name, 4);
}

...
#define EMIF_OCP_CONFIG_SMARCT335X             0x00141414
...
static inline int board_is_smarc_t335x(void)
{
        return board_ti_is("SMARCT33");
}

static inline int board_is_smarc_t335x_80(void)
{
        return board_ti_is("SMARCT80");
}

static inline int board_is_smarc_t335x_1g(void)
{
        return board_ti_is("SMARCT1G");
}
...
static inline int board_is_smarc_t335xx(void)
{
        return board_is_smarc_t335x() || board_is_smarc_t335x_80() || board_is_smarc_t335x_1g();
}

...
/* GPIO that controls power on SMARC-T335X */
#define GPIO_LCD_PWM_EN		GPIO_TO_PIN(0, 7)	/*backlight PWM to the brightest */
#define GPIO_LCD_BKLT_EN	GPIO_TO_PIN(1, 22)	/*backlight enable */
#define GPIO_MMC0_PWR_EN        GPIO_TO_PIN(1, 19)      /*sd card power enable */
...
void do_board_detect(void)
{
	...
	if (ti_i2c_eeprom_am_get(-1, CONFIG_SYS_I2C_EEPROM_ADDR))
		printf("smarc_i2c_eeprom_init failed\n");
}
#endif
...
static struct emif_regs ddr3_smarct335x_emif_reg_data = {
        ...
        .ocp_config = EMIF_OCP_CONFIG_SMARCT335X,
...
const struct dpll_params *get_dpll_ddr_params(void)
{
	...
	else if (board_is_bone_lt() || board_is_icev2() || board_is_smarc_t335x() || board_is_smarc_t335x_80() || board_is_smarc_t335x_1g())
...
const struct dpll_params *get_dpll_mpu_params(void)
{
	...
	if (board_is_bone_lt() || board_is_smarc_t335x_1g())
		freq = MPUPLL_M_1000;
...
void scale_vcores(void)
{
	...
	if (board_is_beaglebonex() || board_is_smarc_t335xx())
...
void sdram_init(void)
{
	...
	if (board_is_evm_sk())
		...
		config_ddr(400, &ioregs_bonelt,
			   ...
			   &ddr3_beagleblack_emif_reg_data, 0);
        else if (board_is_smarc_t335x() || board_is_smarc_t335x_1g()) {
                /*
                ...
                gpio_request(GPIO_MMC0_PWR_EN, "sdio_pwr_en");
                gpio_direction_output(GPIO_MMC0_PWR_EN, 1);
        ...
        else if (board_is_smarc_t335x_80()) {
                /*
                 * SMARC T335X rev. 00B0 and later use gpio0_7 as LCD backlight PWM and gpio1_22 as LCD backlight enable.
                 */
                gpio_request(GPIO_LCD_BKLT_EN, "lcd_bklt_en");
...
int board_late_init(void)
{
	...
	uint32_t mac_hi, mac_lo;
 	...
 	struct ti_am_eeprom data;
        ...
        if (board_is_smarc_t335x() || board_is_smarc_t335x_80() || board_is_smarc_t335x_1g()) {
...
int board_eth_init(bd_t *bis)
{
	...
	if (board_is_bone() || board_is_bone_lt() ||
        ...
        } else if (board_is_smarc_t335x() || board_is_smarc_t335x_80() || board_is_smarc_t335x_1g()) {
...
int board_fit_config_name_match(const char *name)
{
	if (board_is_gp_evm() && !strcmp(name, "am335x-evm"))
		...
		return 0;
        else if (board_is_smarc_t335x() && !strcmp(name, "am335x-smarct335x"))
                return 0;
        else if (board_is_smarc_t335x_80() && !strcmp(name, "am335x-smarct335x"))
                return 0;
        else if (board_is_smarc_t335x_1g() && !strcmp(name, "am335x-smarct335x"))
                return 0;
